view: customer {
  ...
  dimension: location_fr {
    ...
    link: {
      ...
      url: "https://actianavalanchepartner.cloud.looker.com/dashboards/95?Addresser=%22{{ customer.address._value | encode_uri}}%22&Localisation={{customer.location._value | encode_uri}}&IDduClient={{customer.custid._value | encode_uri}}"
      label: "Détail Client"
      icon_url: "https://img.icons8.com/cotton/2x/worldwide-location.png"
    }
  }
  ...
  dimension: location_de {
    ...
    sql_longitude: ${TABLE}.longitude ;;
    link: {
      url: "https://actianavalanchepartner.cloud.looker.com/dashboards/114?Ansprechen=%22{{ customer.address._value | encode_uri}}%22&Standort={{customer.location._value | encode_uri}}&Kundennummer={{customer.custid._value | encode_uri}}"
      label: "Kundendetail"
      icon_url: "https://img.icons8.com/cotton/2x/worldwide-location.png"
    }
  }
