...
view: customer_yesterday {
  sql_table_name: retail.customer_texas_yesterdayview ;;
  ...
  measure: count_distinct_per_address{
    type:  count_distinct
    sql: ${customer_yesterday.address};;
  }
  ...
  dimension: customer_comparitor {
    ...
    CASE
      WHEN {% condition customer_select %} ${customer_yesterday.customer_id} {% endcondition %}
      THEN ${customer_yesterday.customer_id}
